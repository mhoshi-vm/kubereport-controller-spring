...
public class ControllerConfiguration {
    ...
    public CommandLineRunner commandLineRunner(
            SharedInformerFactory sharedInformerFactory, Controller spreadsheetController) {
        return args -> {
    ...
    @Bean
    public Controller SpreadsheetController(
            SharedInformerFactory sharedInformerFactory, SpreadsheetReconciler reconciler) {
        DefaultControllerBuilder builder = ControllerBuilder.defaultBuilder(sharedInformerFactory);
        builder =
                builder.watch(
                        (q) -> ControllerBuilder.controllerWatchBuilder(V1alpha1Spreadsheet.class, q)
    ...
    @Bean
    public SharedIndexInformer<V1alpha1Spreadsheet> spreadsheetSharedIndexInformer(
            ApiClient apiClient, SharedInformerFactory sharedInformerFactory) {
        GenericKubernetesApi<V1alpha1Spreadsheet, V1alpha1SpreadsheetList> genericApi =
                new GenericKubernetesApi<>(
                        V1alpha1Spreadsheet.class, V1alpha1SpreadsheetList.class, "sbp.vmware.jp", "v1alpha1", "spreadsheet", apiClient);
